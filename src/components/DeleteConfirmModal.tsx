...
const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({ isOpen, onClose, onConfirm, course }) => {
                ...
                <div className='mt-3 text-center'>
                    ...
                    <div className='mt-2 px-7 py-3'>
                        <p className='text-sm text-gray-500'>
                            Are you sure you want to delete the course "{course.course_name}"? This action cannot be
                            undone.
                        </p>
                    </div>
                    <div className='items-center px-4 py-3'>
                        <button
                            ...
                            onClick={() => onConfirm(course.course_id)}
                        >
                            Delete
                        </button>
                        <button
